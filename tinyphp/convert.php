...
/**
 * 系统配置文件首先加载
 * Created by tinyphp2.net.
 * Date: 2017/4/13
 * Time: 10:19
 * Author: johnxu <fsyzxz@163.com> 18308103105
 */
...
return [
    ...
    'URL_MODE' => 0, // 0普通模式, 1PATHINFO模式, 2REWRITE模式
    
    'CACHE_MODE' => 'file', // 缓存方式（file：文件缓存，memcached：memcached缓存方式，需要配置memcached参数）
    'CACHE_HTML_MODE' => true, // 是否开启静态html文件缓存
